...
function addQuickEquipItem(item) {
	...
	<a target="_blank" href="https://www.roblox.com/catalog/${parseInt(item.assetId)}/Item">
		<img style="margin-left:10px;width:60px;float:left;" class="border-bottom" data-src="https://api.ropro.io/getAssetThumbnail.php?id=${parseInt(item.assetId)}" src=""></a><div class="border-bottom" style="position:absolute;right:5px;"><div style="float:right;"><a href="https://www.roblox.com/catalog/${parseInt(item.assetId)}/Item">
	</a>
