...
function createRandomGameButton() {
    ...
    randomGameButton.addEventListener("click", function() {
		if (randomGameButton.innerHTML.includes(chrome.i18n.getMessage("RandomGame"))) {
			...
			randomGameButton.innerHTML = `<img class="random-game-icon-${current_theme}" style="width:25px;margin-top:-10px;margin-bottom:-10px;margin-right:8px;${current_theme == "darkmode" ? "filter:invert(0.8);" : "filter:invert(0.2);"}" src="https://ropro.io/images/random_game.svg">`+ chrome.i18n.getMessage("RandomGame")
